...
class NotificationController {
  ...
  static Future<void> executeLongTaskInBackground() async {
    ...
    final re = await apiService.get("http://google.com");
    print(re);
  }
  ...
  static Future<void> createNewNotification({
    ...
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: -1, // -1 is replaced by a random numb
            wakeUpScreen: true,
            channelKey: channel,
  ...
  static Future<void> scheduleNewNotification({
    ...
    var nowDate = DateTime.now()
        .add(Duration(hours: hoursFromNow, minutes: 0, seconds: 0));
    await AwesomeNotifications().createNotification(
      schedule: NotificationCalendar(
        hour: nowDate.hour, // Thời điểm trong ngày (giờ)
        minute: nowDate.minute, // Thời điểm trong ngày (phút)
        second: nowDate.second, // Thời điểm trong ngày (giây)
        millisecond: 0,
        //allowWhileIdle: true,
      ),
